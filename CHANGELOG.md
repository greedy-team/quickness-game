...
**기타**
- Merge pull request #60 from greedy-team/20260519_#59_Vercel_배포_환경_이미지_렌더링_속도_개선
- docs : 리포트 문서 작성 #59
- perf : Vercel 정적 자산 immutable 캐시 헤더 추가 #59
- perf : 이미지 WebP 변환 및 경로 갱신 #59
- feat : sharp 기반 이미지 최적화 스크립트 추가 #59
- chore : 미사용 이미지 6장 삭제 #59
- docs : 이슈 문서 작성 #59
